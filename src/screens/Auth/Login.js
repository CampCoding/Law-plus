...
export default class Login extends Component {
  ...
  signin = async () => {
    ...
    if (this.state.connection_Status == 'Online') {
      axios
        .post(
          AppRequired.Domain + 'authentication/student_login.php',
          data_to_send,
        )
        .then(async (res) => {
          ...
          if (res.status == 200) {
            if (res.data == 'not_authorized') {
              ...
              if (res.data.skip_sim == '1') {
                if (res.data.student_status == 'pending') {
                  // alert(JSON.stringify(res.data))
                  this.setData(res.data, 'Pending');
                ...
                if (allowCarrier) {
                  ...
                  Alert.alert(AppRequired.appName, 'دخول غير مسموح');
                }
              }
            }
          } else {
