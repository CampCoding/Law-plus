...
export default class FullPageExamWithAnswers extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      status: 'not_done',
              ...
              <LinearGradient
                ...
                <Text
                  style={{
                    ...
                    fontSize: 25,
                    color: '#FFF',
                    fontFamily: fontFaFONTS.fontFamilymily,
                  }}>
                  اغلاق
                </Text>
              </LinearGradient>
  ...
  //                     : '#fff',
  //             }}>
  //             <Left style={{ paddingLeft: 6, flex: 5, flexDirection: 'row' }}>
  // {index == item.question_valid_answer ?
  //   <View
  //     style={{
  //       borderColor: '#5cb85c',
  ...
  //     }}>
  //     <MaterialIcons name="check" style={{ fontSize: 30, color: '#FFF', alignSelf: 'center' }} />
  //   </View> :
  //   <View
  //     style={{
  //       borderColor: '#8A3982',
  ...
  //       backgroundColor: '#f00',
  //     }}>
  //     <MaterialIcons name="close" style={{ fontSize: 30, color: '#FFF', alignSelf: 'center' }} />
  //   </View>
  ...
  //     axios.post(Domain + 'upload_score.php', data_to_send).then((res) => {
  ...
  //   } else {
  //     this.setState({ buttonLoading: false });
  //     Alert.alert(appName + '', 'من فضلك تحقق من اتصالك بالأنترنت', [
  //       {
  //         text: '',
