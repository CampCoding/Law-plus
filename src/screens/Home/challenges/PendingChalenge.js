...
export default class PendingChalenge extends Component {
  ...
  async getdata() {
    ...
    axios
      .post(
        AppRequired.Domain + 'home/challenge/select_pendding_challanges.php',
        data_to_send,
      )
      .then((res) => {
  ...
  acceptChallenge = async (challenge_id, index) => {
    ...
    axios
      .post(AppRequired.Domain + 'home/challenge/accept_challange.php', data_to_send)
      .then((res) => {
        // alert(res.data);
        // console.log(res.data);
  ...
  async remove_item(index, challenge_id) {
    ...
    axios
      .post(AppRequired.Domain + 'home/challenge/refuse_challange.php', data_to_send)
      .then((res) => {
        // alert(res.data);
        this.setState({
          buttonCancelLoading: false,
