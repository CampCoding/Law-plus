...
export default class ExamList extends React.Component {
  ...
  async get_exams(generation_id, student_id) {
    ...
    axios
      .post(AppRequired.Domain + 'home/select_exam.php', data_to_send)
      .then((res) => {
  ...
  makeRequestToSaveDefaultScore = async (
    ...
    axios
      .post(
        AppRequired.Domain + 'home/add_first_score_exam_quiz.php',
        data_to_send,
      )
      .then((response) => {
        this.setState({
