...
export default class Settings extends React.Component {
  ...
  changeParentPhone = () => {
    ...
    axios
      .post(AppRequired.Domain + 'home/update_parent_phone.php', data_to_send)
      .then(async (res) => {
        if (res.status == 200) {
          if (res.data == 'success') {
            this.setState({
  ...
  changePersonalPhone = () => {
    ...
    axios
      .post(AppRequired.Domain + 'home/update_student_phone.php', data_to_send)
      .then(async (res) => {
        if (res.status == 200) {
          if (res.data == 'success') {
            this.setState({
  ...
  changeEmail = () => {
    ...
    axios
      .post(AppRequired.Domain + 'home/update_student_email.php', data_to_send)
      .then(async (res) => {
        if (res.status == 200) {
          if (res.data == 'success') {
            this.setState({
  ...
  changeName = () => {
    ...
    axios
      .post(AppRequired.Domain + 'home/update_student_name.php', data_to_send)
      .then(async (res) => {
        if (res.status == 200) {
          if (res.data == 'success') {
            this.setState({
  ...
  changePassword = () => {
    ...
    axios
      .post(
        AppRequired.Domain + 'home/update_student_password.php',
        data_to_send,
      )
      .then(async (res) => {
        if (res.status == 200) {
