              ...
              (this.state.connection_Status != 'Online' &&
                ...
                <>
                  ...
                  parseInt(this.state.view_limit_count) ? (
                    !this.state.playingVideo.includes('update_app.mp4') ? (
                      <Video
          ...
          `,
                    ...
                    <View style={{width: '100%', padding: 20}}>
                      ...
                      <Text
                        ...
                        عفواً لم يعد متاح إليك مشاهده هذا الفيديو من السلسه
                      </Text>
                      <TouchableOpacity
                        onPress={() => this.setState({unableWatchModal: true})}
                        style={{
                          alignSelf: 'center',
                          paddingVertical: 10,
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    if (this.state.videoDetails.exam_type == '000') {
                      ...
                      let very_good_video = this.state.videoDetails
                        .very_good_video;
                      let excellent_video = this.state.videoDetails
                        .excellent_video;
