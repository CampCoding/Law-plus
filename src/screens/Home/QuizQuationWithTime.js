...
export default class QuizInOnePageWithTime1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
      ...
      URLarray: [
        {
          id: '1',
          url:
            'https://youtu.be/r226svjTVn0?list=PL91xPELaCszXD_jG9hT_Jmzm5qYAiXPIm',
          image: images.Camp,
        },
        {
          id: '2',
          url:
            'https://youtu.be/OKLdBdE3CTQ?list=PL91xPELaCszVM16GIqkiK0qgCQcghbZyj',
          image: images.Camp,
        },
        {
          id: '3',
          url:
            'https://youtu.be/rKu_--bS1fQ?list=PL91xPELaCszVM16GIqkiK0qgCQcghbZyj',
          image: images.Camp,
        },
        {
          id: '4',
          url:
            'https://youtu.be/i7nx2Gw2ffs?list=PL91xPELaCszVM16GIqkiK0qgCQcghbZyj',
          image: images.Camp,
        },
      ],
    };
      ...
      <View
        ...
        <ScrollView>
          ...
          <View style={{marginTop: 30}}>
            {item.real_answers.map((item1, index) => (
              <TouchableOpacity
                style={{
                  borderColor: 'black',
                  borderWidth: 1,
                  ...
                  borderColor:
                    item1 == item.chosen_answer ? '#5cb85c' : 'black',
                  backgroundColor:
                    ...
                    <View
                      ...
                      <Text
                        style={{
                          fontSize: 14,
                          fontFamily: FONTS.fontFamily,
                          // textAlign: item1 == item.chosen_answer ? "center" : null
                        }}>
                        {item1}
                      </Text>
                    </View>
                    ...
                    <View style={{flexDirection: 'row'}}>
                      <Text
                        style={{
                          color: '#FFF',
                          fontSize: 18,
                          fontFamily: FONTS.fontFamily, // marginRight:30,
                          // textAlign:"center"
                        }}>
                        التالى
                      </Text>
